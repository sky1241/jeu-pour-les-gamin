...
Config::load()
{
  ...
  if (config_mapping.get("control", config_control_mapping))
  {
    ...
    config_control_mapping->get("tilt_enabled", tilt_enabled);
    config_control_mapping->get("tilt_deadzone", tilt_deadzone, 2);
    config_control_mapping->get("tilt_sensitivity", tilt_sensitivity, 2);
...
Config::save()
{
  ...
  writer.start_list("control");
  {
    ...
    writer.write("tilt_enabled", tilt_enabled);
    writer.write("tilt_deadzone", tilt_deadzone);
    writer.write("tilt_sensitivity", tilt_sensitivity);
