...
public:
  ...
  bool tilt_enabled;          // Use accelerometer for movement
  float tilt_deadzone;        // Dead zone threshold in m/s² (default 1.5)
  float tilt_sensitivity;     // Sensitivity multiplier (default 1.0)
